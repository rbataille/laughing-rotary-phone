...
public class MainTest {
    ...
    public void mainTest() throws Exception {
        final String configFile = "conf/config.test.ini";
        final String[] parameters = {"-config", configFile};

        Main.main(parameters);

        final String response = MainTest.executePost("http://localhost:8055/app", "int1=3&int2=5&limit=16&str1=fizz&str2=buzz");
        ...
        final String r2 = MainTest.get("localhost", "invalid_url", 8055);
